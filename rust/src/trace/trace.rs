...
use crate::trace::inspector::MyInspector;
...
pub fn trace_transaction(
...
) -> Result<TraceTransactionResult<HaltReason>, String> {
    ...
    Ok(TraceTransactionResult { execution_result, state_diff, trace })
}
...
pub fn op_trace_transaction(
    ...
    latest_block_env: BlockEnv,
    prestate_tracer_result: HashMap<Address, AccountDetails>
) -> Result<TraceTransactionResult<OpHaltReason>, String> {
